...
## 3. What Iterated Self-Feeding Probes of Language Models Measure, and a test that separates the construction from the model / 语言模型的迭代自馈式探针测量什么，以及将构造与模型分开的测试
...
## 10. MedUP: Awakening Unified Understanding and Perception in Medical Vision-Language Models / MedUP：唤醒医学视觉语言模型的统一理解和感知
...
## 35. HarnessWAM: Bridging Prediction and Deliberation in World Action Models / HarnessWAM：连接世界行动模型中的预测和审议
