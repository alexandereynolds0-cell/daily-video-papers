...
## 3. How Many Iterations to Jailbreak? Dynamic Budget Allocation for Multi-Turn LLM Evaluation / 越狱需要多少次迭代？多轮法学硕士评估的动态预算分配
...
## 4. Patch2Vuln: Agentic Reconstruction of Vulnerabilities from Linux Distribution Binary Patches / Patch2Vuln：从 Linux 发行版二进制补丁中代理重建漏洞
...
## 5. Cross-Modal Navigation with Multi-Agent Reinforcement Learning / 具有多代理强化学习的跨模式导航
...
## 6. NeuroAgent: LLM Agents for Multimodal Neuroimaging Analysis and Research / NeuroAgent：用于多模式神经影像分析和研究的法学硕士代理
...
## 7. Coordination Matters: Evaluation of Cooperative Multi-Agent Reinforcement Learning / 协调很重要：协作多智能体强化学习的评估
...
## 8. Market-Alignment Risk in Pricing Agents: Trace Diagnostics and Trace-Prior RL under Hidden Competitor State / 定价代理的市场调整风险：隐藏竞争对手状态下的追踪诊断和追踪先验强化学习
...
## 9. Process Matters more than Output for Distinguishing Humans from Machines / 对于区分人类和机器而言，过程比输出更重要
...
## 10. Agentic AIs Are the Missing Paradigm for Out-of-Distribution Generalization in Foundation Models / 代理人工智能是基础模型中分布外泛化缺失的范式
...
## 11. Beyond Task Success: Measuring Workflow Fidelity in LLM-Based Agentic Payment Systems / 超越任务成功：测量基于法学硕士的代理支付系统中的工作流程保真度
...
## 12. Knowledge Graphs, the Missing Link in Agentic AI-based Formal Verification / 知识图谱，基于代理人工智能的形式验证中缺失的环节
...
## 13. Independent Learning of Nash Equilibria in Partially Observable Markov Potential Games with Decoupled Dynamics / 解耦动力学部分可观马尔可夫势博弈中纳什均衡的独立学习
...
我们在部分可观察马尔可夫博弈（POMG）中研究纳什均衡学习，这是一种多智能体强化学习框架，其中智能体无法完全观察潜在状态。这种情况下的先前工作依赖于集中化或信息共享，并且受到样本和计算复杂性的影响，该复杂性随着玩家数量的增加而呈指数级增长。我们关注具有独立状态转换的 POMG 子类，其中代理通过奖励保持耦合，并假设底层完全观察到的马尔可夫博弈是马尔可夫势博弈。对于此类，我们提出了一种独立的学习算法，其中玩家仅观察自己的行为和观察结果并且没有交流，共同收敛到近似纳什均衡。由于部分可观察性，最优策略通常可能取决于完整的行动观察历史。在滤波器稳定性假设下，我们表明基于有限历史窗口的策略提供了足够的近似保证。这使我们能够通过接近势的代理马尔可夫博弈来近似 POMG，从而导致基础 POMG 中独立纳什均衡学习的拟多项式样本和计算复杂性。

</details>

---

## 14. From Agent Loops to Deterministic Graphs: Execution Lineage for Reproducible AI-Native Work / 从代理循环到确定性图：可重复的 AI 原生工作的执行沿袭
...
## 15. More Than Can Be Said: A Benchmark and Framework for Pre-Question Scientific Ideation / 不胜枚举：问题前科学构思的基准和框架
...
## 16. Safactory: A Scalable Agent Factory for Trustworthy Autonomous Intelligence / Safactory：可扩展的代理工厂，提供值得信赖的自主智能
...
## 17. FunctionalAgent: Towards end-to-end on-top functional design / FunctionAgent：走向端到端的顶层功能设计
...
## 18. Bandit Learning in General Open Multi-agent Systems / 通用开放多智能体系统中的强盗学习
...
## 19. VibeServe: Can AI Agents Build Bespoke LLM Serving Systems? / VibeServe：人工智能代理可以构建定制的 LLM 服务系统吗？
...
## 20. Multi-agent decision making: A Blackwell's informativeness approach / 多智能体决策：布莱克威尔的信息方法
...
## 21. BioResearcher: Scenario-Guided Multi-Agent for Translational Medicine / BioResearcher：场景引导的转化医学多智能体
...
## 22. BehaviorGuard: Online Backdoor Defense for Deep Reinforcement Learning / BehaviourGuard：深度强化学习的在线后门防御
...
## 23. MAS-Algorithm: A Workflow for Solving Algorithmic Programming Problems with a Multi-Agent System / MAS-Algorithm：使用多代理系统解决算法编程问题的工作流程
...
## 24. Agentic, Context-Aware Risk Intelligence in the Internet of Value / 价值互联网中的代理式上下文感知风险情报
