...
## 18. Dynamic Attentional Context Scoping: Agent-Triggered Focus Sessions for Isolated Per-Agent Steering in Multi-Agent LLM Orchestration / 动态注意力上下文范围：多代理 LLM 编排中用于独立每个代理指导的代理触发焦点会话
