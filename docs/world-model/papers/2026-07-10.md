...
## 2. Write-Protected Discrete Bottlenecks for Language-Grounded World Models: A Structural Limitation and Sufficient Fix / 基于语言的世界模型的写保护离散瓶颈：结构限制和充分修复
...
## 3. Unlocking Temporal Generalization in Hamiltonian Video Dynamics Models / 解锁哈密顿视频动力学模型中的时间泛化
