...
## 16. Towards In-Depth Root Cause Localization for Microservices with Multi-Agent Recursion-of-Thought / 通过多代理思想递归实现微服务的深入根本原因定位
...
## 17. A Deterministic Agentic Workflow for HS Tariff Classification: Multi-Dimensional Rule Reasoning with Interpretable Decisions / HS关税分类的确定性代理工作流程：具有可解释决策的多维规则推理
...
## 18. IFPV: An Integrated Multi-Agent Framework for Generative Operational Planning and High-Fidelity Plan Verification / IFPV：用于生成运营规划和高保真计划验证的集成多代理框架
...
## 19. Beyond AI as Assistants: Toward Autonomous Discovery in Cosmology / 超越人工智能助手：迈向宇宙学的自主发现
...
## 20. Probabilistic Verification of Recurrent Neural Networks for Single and Multi-Agent Reinforcement Learning / 单智能体和多智能体强化学习循环神经网络的概率验证
...
## 21. Agentifying Patient Dynamics within LLMs through Interacting with Clinical World Model / 通过与临床世界模型的交互来代理法学硕士内的患者动态
...
## 22. SR-Platform: An Agentic Pipeline for Natural Language-Driven Robot Simulation Environment Synthesis / SR-Platform：自然语言驱动的机器人仿真环境综合的代理管道
...
## 23. Agentic Design of Compositional Descriptors via Autoresearch for Materials Science Applications / 通过材料科学应用的自动研究进行成分描述符的代理设计
...
## 24. Falkor-IRAC: Graph-Constrained Generation for Verified Legal Reasoning in Indian Judicial AI / Falkor-IRAC：印度司法人工智能中经过验证的法律推理的图约束生成
...
## 25. In-IDE Toolkit for Developers of AI-Based Features / 为基于 AI 的功能开发人员提供的 In-IDE 工具包
...
## 26. Remember Your Trace: Memory-Guided Long-Horizon Agentic Framework for Consistent and Hierarchical Repository-Level Code Documentation / 记住你的痕迹：内存引导的长视野代理框架，用于一致和分层的存储库级代码文档
...
## 27. Resolving Action Bottleneck: Agentic Reinforcement Learning Informed by Token-Level Energy / 解决行动瓶颈：以代币级能量为基础的代理强化学习
...
## 28. Cattle Trade: A Multi-Agent Benchmark for LLM Bluffing, Bidding, and Bargaining / 牛贸易：LLM 虚张声势、出价和讨价还价的多代理基准
...
## 29. Lang2MLIP: End-to-End Language-to-Machine Learning Interatomic Potential Development with Autonomous Agentic Workflows / Lang2MLIP：端到端语言到机器学习原子间潜力开发与自主代理工作流程
...
## 30. Contestable Multi-Agent Debate with Arena-based Argumentative Computation for Multimedia Verification / 可竞争的多智能体辩论与基于竞技场的多媒体验证论证计算
...
## 31. LEMON: Learning Executable Multi-Agent Orchestration via Counterfactual Reinforcement Learning / LEMON：通过反事实强化学习学习可执行的多代理编排
...
## 32. Test-Time Learning with an Evolving Library / 通过不断发展的图书馆进行测试时学习
...
## 33. Agentic Recommender System with Hierarchical Belief-State Memory / 具有分层信念状态记忆的代理推荐系统
...
## 34. Coding Agent Is Good As World Simulator / 编码代理与世界模拟器一样好
...
## 35. Nexus : An Agentic Framework for Time Series Forecasting / Nexus：时间序列预测的代理框架
...
## 36. Data-Augmented Game Starts for Accelerating Self-Play Exploration in Imperfect Information Games / 数据增强游戏启动，加速不完美信息游戏中的自我探索
...
## 37. Herculean: An Agentic Benchmark for Financial Intelligence / Herculean：金融情报的代理基准
...
## 38. Auditing Agent Harness Safety / 审核代理安全
...
## 39. Agentic AI Ecosystems in Higher Education: A Perspective on AI Agents to Emerging Inclusive, Agentic Multi-Agent AI Framework for Learning, Teaching and Institutional Intelligence / 高等教育中的代理人工智能生态系统：人工智能代理对新兴包容性、代理多代理人工智能学习、教学和机构智能框架的看法
...
## 40. Hypergraph Enterprise Agentic Reasoner over Heterogeneous Business Systems / 异构业务系统上的超图企业代理推理器
...
## 41. ASH: Agents that Self-Hone via Embodied Learning / ASH：通过具身学习自我磨练的智能体
...
## 42. MAPLE: Latent Multi-Agent Play for End-to-End Autonomous Driving / MAPLE：端到端自动驾驶的潜在多代理游戏
...
## 43. QOuLiPo: What a quantum computer sees when it reads a book / QOuLiPo：量子计算机读书时看到了什么
...
## 44. Mini-JEPA Foundation Model Fleet Enables Agentic Hydrologic Intelligence / Mini-JEPA 基金会模型舰队实现代理水文情报
...
## 45. ProtoMedAgent: Multimodal Clinical Interpretability via Privacy-Aware Agentic Workflows / ProtoMedAgent：通过隐私意识代理工作流程实现多模式临床可解释性
...
## 46. Self-Pruned Key-Value Attention: Learning When to Write by Predicting Future Utility / 自修剪键值注意力：通过预测未来效用来学习何时写作
...
## 47. VectraYX-Nano: A 42M-Parameter Spanish Cybersecurity Language Model with Curriculum Learning and Native Tool Use / VectraYX-Nano：具有课程学习和本机工具使用的 42M 参数西班牙语网络安全语言模型
