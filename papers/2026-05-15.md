...
了解表面运动学之外的人体运动对于运动分析、康复和伤害风险评估至关重要。然而，由于缺乏带有生物力学注释的大规模数据集，以及现有方法无法从视觉观察直接推断内部生物力学状态，该领域的进展受到限制。在本文中，我们介绍了一种基于模拟的框架，用于根据现有运动捕捉数据集估计肌肉激活，从而产生 BioHuman10M，这是一个具有同步视频、运动和激活的大型数据集。在 BioHuman10M 的基础上，我们提出了 BioHuman，这是一种端到端模型，以单目视频作为输入，联合预测人体运动和肌肉激活，有效地桥接视觉观察和内部生物力学状态。大量实验表明，BioHuman 能够准确重建运动学运动和肌肉活动，并推广到不同的受试者和运动。我们相信我们的方法为基于视频的生物力学理解建立了新的基准，并为基于物理的人体建模开辟了新的可能性。
