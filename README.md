...
<!-- PAPERS_INDEX_START -->
- [2026-04-02](papers/2026-04-02.md) - 1 papers
- [2026-03-31](papers/2026-03-31.md) - 17 papers
- [2026-03-27](papers/2026-03-27.md) - 22 papers
- [2026-03-26](papers/2026-03-26.md) - 16 papers
- [2026-03-25](papers/2026-03-25.md) - 23 papers
- [2026-03-24](papers/2026-03-24.md) - 26 papers
...
- [2026-03-05](papers/2026-03-05.md) - 7 papers
...
<details><summary><b>2026-04-02 (1 papers)</b></summary>
...
<details><summary><b>2026-03-31 (17 papers)</b></summary>
...
## 1. AdaptToken: Entropy-based Adaptive Token Selection for MLLM Long Video Understanding / AdaptToken：用于 MLLM 长视频理解的基于熵的自适应令牌选择
...
## 2. ResAdapt: Adaptive Resolution for Efficient Multimodal Reasoning / ResAdapt：高效多模态推理的自适应分辨率
...
## 3. AutoCut: End-to-end advertisement video editing based on multimodal discretization and controllable generation / AutoCut：基于多模态离散化和可控生成的端到端广告视频编辑
...
## 4. VistaGEN: Consistent Driving Video Generation with Fine-Grained Control Using Multiview Visual-Language Reasoning / VistaGEN：使用多视图视觉语言推理通过细粒度控制生成一致的驾驶视频
...
## 5. LogiStory: A Logic-Aware Framework for Multi-Image Story Visualization / LogiStory：多图像故事可视化的逻辑感知框架
...
## 6. RehearsalNeRF: Decoupling Intrinsic Neural Fields of Dynamic Illuminations for Scene Editing / RehearsalNeRF：解耦场景编辑的动态照明的内在神经场
...
## 7. FlashSign: Pose-Free Guidance for Efficient Sign Language Video Generation / FlashSign：用于高效手语视频生成的无姿势指南
...
## 8. Wan-R1: Verifiable-Reinforcement Learning for Video Reasoning / Wan-R1：视频推理的可验证强化学习
...
## 9. Tracking without Seeing: Geospatial Inference using Encrypted Traffic from Distributed Nodes / 无需查看即可跟踪：使用来自分布式节点的加密流量进行地理空间推断
...
## 10. Can Unsupervised Segmentation Reduce Annotation Costs for Video Semantic Segmentation? / 无监督分割能否降低视频语义分割的标注成本？
...
## 11. A Benchmarking Methodology to Assess Open-Source Video Large Language Models in Automatic Captioning of News Videos / 评估新闻视频自动字幕中开源视频大语言模型的基准方法
...
## 12. V-CAST: Video Curvature-Aware Spatio-Temporal Pruning for Efficient Video Large Language Models / V-CAST：视频曲率感知时空剪枝，实现高效视频大语言模型
...
## 13. STRIDE: When to Speak Meets Sequence Denoising for Streaming Video Understanding / STRIDE：何时说话与流视频理解的序列去噪相结合
...
## 14. TokenDial: Continuous Attribute Control in Text-to-Video via Spatiotemporal Token Offsets / TokenDial：通过时空令牌偏移进行文本到视频的连续属性控制
...
## 15. KV Cache Quantization for Self-Forcing Video Generation: A 33-Method Empirical Study / 用于自强制视频生成的 KV 缓存量化：33 种方法的实证研究
...
## 16. LOME: Learning Human-Object Manipulation with Action-Conditioned Egocentric World Model / LOME：使用以动作为条件的自我中心世界模型学习人机操作
...
## 17. HMPDM: A Diffusion Model for Driving Video Prediction with Historical Motion Priors / HMPDM：利用历史运动先验驱动视频预测的扩散模型
...
<details><summary><b>2026-03-27 (22 papers)</b></summary>
...
## 13. Free-Lunch Long Video Generation via Layer-Adaptive O.O.D Correction / 通过层自适应 O.O.D 校正生成免费长视频
...
<details><summary><b>2026-03-26 (16 papers)</b></summary>
...
<details><summary><b>2026-03-25 (23 papers)</b></summary>
...
当面对现实世界的损坏（例如模糊、噪声和压缩伪影）时，基于高质量数据训练的光流模型通常会严重退化。为了克服这一限制，我们制定了退化感知光流，这是一项新任务，旨在从现实世界的损坏视频中进行准确的密集对应估计。我们的主要见解是，图像恢复扩散模型的中间表示本质上是腐败感知的，但缺乏时间感知。为了解决这个限制，我们提升模型通过完整的时空注意力来参与相邻帧，并凭经验证明所得到的特征表现出零样本对应能力。基于这一发现，我们提出了 DA-Flow，这是一种混合架构，它将这些扩散特征与迭代细化框架内的卷积特征融合在一起。在多个基准测试严重退化的情况下，DA-Flow 的性能大大优于现有的光流方法。
...
<details><summary><b>2026-03-24 (26 papers)</b></summary>
...
## 1. VideoDetective: Clue Hunting via both Extrinsic Query and Intrinsic Relevance for Long Video Understanding / VideoDetective：通过外部查询和内部相关性进行线索搜寻以实现长视频理解
...
## 2. DUO-VSR: Dual-Stream Distillation for One-Step Video Super-Resolution / DUO-VSR：用于一步视频超分辨率的双流蒸馏
...
## 3. Omni-WorldBench: Towards a Comprehensive Interaction-Centric Evaluation for World Models / Omni-WorldBench：对世界模型进行全面的以交互为中心的评估
...
## 4. PAM: A Pose-Appearance-Motion Engine for Sim-to-Real HOI Video Generation / PAM：用于生成模拟至真实 HOI 视频的姿势-外观-运动引擎
...
## 5. Mamba-VMR: Multimodal Query Augmentation via Generated Videos for Precise Temporal Grounding / Mamba-VMR：通过生成的视频进行多模式查询增强，以实现精确的时间基础
...
## 6. StreamingClaw Technical Report / StreamingClaw 技术报告
...
## 7. P-Flow: Prompting Visual Effects Generation / P-Flow：促进视觉效果生成
...
## 8. Unified Spatiotemporal Token Compression for Video-LLMs at Ultra-Low Retention / 超低保留视频法学硕士的统一时空令牌压缩
...
## 9. Manifold-Aware Exploration for Reinforcement Learning in Video Generation / 视频生成中强化学习的流形感知探索
...
## 10. Adaptive Video Distillation: Mitigating Oversaturation and Temporal Collapse in Few-Step Generation / 自适应视频蒸馏：在几步生成中减轻过饱和和时间崩溃
...
## 11. Climate Prompting: Generating the Madden-Julian Oscillation using Video Diffusion and Low-Dimensional Conditioning / 气候提示：使用视频扩散和低维条件生成马登-朱利安振荡
...
## 12. FedCVU: Federated Learning for Cross-View Video Understanding / FedCVU：跨视图视频理解的联邦学习
...
## 13. Dual-level Adaptation for Multi-Object Tracking: Building Test-Time Calibration from Experience and Intuition / 多目标跟踪的双层适应：根据经验和直觉构建测试时校准
...
## 14. CataractSAM-2: A Domain-Adapted Model for Anterior Segment Surgery Segmentation and Scalable Ground-Truth Annotation / CataractSAM-2：用于眼前段手术分割和可扩展的真实注释的领域适应模型
...
## 15. PROBE: Diagnosing Residual Concept Capacity in Erased Text-to-Video Diffusion Models / 探索：诊断已擦除文本到视频扩散模型中的残留概念能力
...
## 16. StreamingEval: A Unified Evaluation Protocol towards Realistic Streaming Video Understanding / StreamingEval：实现真实流媒体视频理解的统一评估协议
...
## 17. Learning Trajectory-Aware Multimodal Large Language Models for Video Reasoning Segmentation / 学习用于视频推理分割的轨迹感知多模态大语言模型
...
## 18. Relax Forcing: Relaxed KV-Memory for Consistent Long Video Generation / 松弛强制：松弛 KV 内存以实现一致的长视频生成
...
## 19. EmoTaG: Emotion-Aware Talking Head Synthesis on Gaussian Splatting with Few-Shot Personalization / EmoTaG：基于高斯泼溅的情感感知头部说话合成，具有少样本个性化
...
## 20. FluidWorld: Reaction-Diffusion Dynamics as a Predictive Substrate for World Models / FluidWorld：反应扩散动力学作为世界模型的预测基础
...
## 21. Privacy-Preserving Federated Action Recognition via Differentially Private Selective Tuning and Efficient Communication / 通过差分隐私选择性调整和高效通信实现隐私保护联合动作识别
...
## 22. Identity-Consistent Video Generation under Large Facial-Angle Variations / 大面部角度变化下身份一致的视频生成
...
## 23. Pretrained Video Models as Differentiable Physics Simulators for Urban Wind Flows / 预训练视频模型作为城市风流的可微分物理模拟器
...
## 24. Single-Eye View: Monocular Real-time Perception Package for Autonomous Driving / 单眼视图：自动驾驶单目实时感知包
...
## 25. A Two-stage Transformer Framework for Temporal Localization of Distracted Driver Behaviors / 用于分心驾驶员行为时间定位的两级 Transformer 框架
...
## 26. Scene Graph-guided SegCaptioning Transformer with Fine-grained Alignment for Controllable Video Segmentation and Captioning / 场景图引导的 SegCaptioning 转换器，具有细粒度对齐功能，可实现可控视频分割和字幕
...
## 3. Improving Image-to-Image Translation via a Rectified Flow Reformulation / 通过整流流重构改进图像到图像的转换
...
<details><summary><b>2026-03-19 (31 papers)</b></summary>
...
## 12. EVA: Aligning Video World Models with Executable Robot Actions via Inverse Dynamics Rewards / EVA：通过反向动态奖励将视频世界模型与可执行的机器人动作结合起来
...
我们推出了 StereoWorld，一种相机调节的立体世界模型，它共同学习外观和双目几何形状以生成端到端立体视频。与单目 RGB 或 RGBD 方法不同，StereoWorld 专门在 RGB 模态内运行，同时直接根据视差来基础几何形状。为了有效地实现一致的立体生成，我们的方法引入了两个关键设计：（1）统一的相机框架 RoPE，通过相机感知的旋转位置编码增强潜在标记，实现相对、视图和时间一致的调节，同时通过稳定的注意力初始化保留预先训练的视频先验； (2) 立体感知注意力分解，将完整的 4D 注意力分解为 3D 视图内注意力和水平行注意力，利用极线先于以低得多的计算捕获视差对齐对应关系。在各个基准测试中，StereoWorld 比强大的单目然后转换管道提高了立体一致性、视差精度和相机运动保真度，实现了 3 倍以上的生成速度，并且视点一致性额外提高了 5%。除了基准之外，StereoWorld 还可以实现端到端双目 VR 渲染，无需深度估计或修复，通过公制尺度深度基础增强具体策略学习，并与长视频蒸馏兼容以扩展交互式立体合成。
...
<details><summary><b>2026-03-18 (24 papers)</b></summary>
...
<details><summary><b>2026-03-09 (9 papers)</b></summary>
...
<details><summary><b>2026-03-07 (18 papers)</b></summary>
...
<details><summary><b>2026-03-05 (7 papers)</b></summary>
